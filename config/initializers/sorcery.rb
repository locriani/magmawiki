...
Rails.application.config.sorcery.submodules = [] #:user_activation, :reset_password, :remember_me, :session_timeout, :brute_force_protection, :activity_logging, :external]
